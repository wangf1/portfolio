...
import { addComment } from "@/frontend/lib/redux/blog/comments/commentsSlice";
...
import "@/frontend/common/Tiptap.css";
import { useAppDispatch } from "@/frontend/lib/hooks";
...
const Tiptap = ({
  ...
  return (
    <div className="border border-gray-700 pl-4 rounded my-6 p-4">
